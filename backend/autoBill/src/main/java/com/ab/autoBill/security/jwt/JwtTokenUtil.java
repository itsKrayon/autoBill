...
public class JwtTokenUtil implements Serializable {
    ...
    private static HashMap<String,String> validToken = new HashMap<String, String>();
    ...
    public String generateToken(User user) {
        ...
        validToken.put(user.getUsername(),jwt);
        return jwt;
    }
    ...
    public boolean validateToken(String jwtToken, UserDetails userDetails) {
        ...
        return validToken.get(username).equals(jwtToken) && username.equals(userDetails.getUsername()) && !isTokenExpired(jwtToken);
    }
